...
```
Reading the article by Qadri about Pakistan’s NADRA database really made me think. Before, I always thought databases were just boring files in a computer. But Qadri shows how a simple digital form can force a whole country to follow one specific idea of a "family." Because the NADRA system only allows a male "head of household," it completely ignores people who live differently, like the khawaja siras. This made me realize that databases are not neutral. They actually push certain values on us and decide who is seen by society.

We can see this clearly in the software for online test proctoring. Back in COVID-19 period, a lot of schools use online proctoring softwares to stop students from cheating. The problem is, the software is made to look for "normal" test behavior. It assumes every student has a perfectly quiet, private room and a brain that can just stare straight at the screen for hours. But if a student naturally looks away to think, or if they live in a small, crowded apartment where a family member might walk behind them, the database flags them as suspicious. The computer system punishes students just because their living situation or thinking style does not fit the standard rules.

I also see these hidden rules in some websites, like booking a flight or filling out government forms. Many of these computer systems were built by people who assume everyone has a standard first name and last name. If a person comes from a culture where they only use one name, or if their name is very short, the database gives an "invalid name" error. To just buy a ticket, the system forces people to spell their own name wrong, or input their name twice in two required fields. The database assumes its way is the correct way, and treats other cultures like a computer error.

Even shopping databases do this. Many big stores use tracking databases to watch how often customers return items. The system gives people a secret risk score. The value system here is that returning items too much is bad. But this is very unfair to people with less money. A parent might buy a few sizes of clothes for their kids to try at home, and then return the ones that don't fit to get their money back. The database sees this normal budgeting as a risk, and might ban them from returning things again. Even for some food delivery platform, the system would monitor and trigger manual review if that person has been complaining about the food or services.

In the end, how a database is designed is a way to control people. The programmers who write the code decide what is normal and safe. If your life, your name, or your money situation does not fit into the boxes they made, the computer will not bypass those errors. Instead, you have to change yourself to fit the system. It shows that technology is never truly fair; it just copies the biases of the humans who build it.
```
